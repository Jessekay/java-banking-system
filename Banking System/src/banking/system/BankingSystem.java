        ...
        while(condition){    
            ...
            switch(choice){
                case 1:
                    ...
                    try{
                        // Step 0: Surround withy try and catch
                    ...
                    String sql= "INSERT INTO  Customers (nid, names,age, phone_number,account_number)values('"+nationalID+"','"+names+"',"+age+",'"+phoneNumber+"','"+accountNumber+"')" ;
